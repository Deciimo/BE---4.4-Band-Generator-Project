...
app.post("/submit", (req, res) => {
  ...
  const adjWord = adj[Math.floor(Math.random() * adj.length)];
  const nounWord =  noun[Math.floor(Math.random() * noun.length)];
  res.render ("index.ejs",{ adjective: adjWord, noun: nounWord });
});
